...
public class DerechClass
{
    ...
    private void homePage() throws IOException
    {
        ...
        while(keepRunning)
        {
            ...
            String[] answerOptions = {"A. View limud progress ", "B. Update limud progress", "C. Delete a Limud", "D. End program"};
            ...
            String answer = reader.readLine();
                switch (answer)
                {
                    ...
                    case "D":
                        ...
                        break;
                    default:
                        System.out.println("You failed to enter a valid option, so we're shutting you down");
                        keepRunning = false;
                        break;
                }
        }
